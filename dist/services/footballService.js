...
exports.footballService = exports.FootballService = void 0;
const footballApiClient_1 = require("../utils/footballApiClient");
...
class FootballService {
    constructor() {
        this.client = (0, footballApiClient_1.getFootballAPIClient)();
    }
    /**
    ...
    async searchTeams(teamName) {
        ...
        try {
            ...
            cache_1.cache.set(cacheKey, teams, 86400); // Cache for 24 hours
            return teams;
        }
        catch (error) {
    ...
    async getTeamById(teamId) {
        ...
        try {
            ...
            if (response.response && response.response.length > 0) {
                ...
                cache_1.cache.set(cacheKey, team, 86400); // Cache for 24 hours
                return team;
            }
            return null;
        }
    ...
    async getAllTeams(options) {
        ...
        try {
            ...
            cache_1.cache.set(cacheKey, result, 3600);
            return result;
        }
        catch (error) {
    ...
    async getAllCountries() {
        ...
        try {
            ...
            const response = await this.client.get('/teams/countries');
            ...
            cache_1.cache.set(cacheKey, result, 86400);
            return result;
        }
        catch (error) {
    ...
    async getHeadToHead(team1Id, team2Id, last = 10) {
        ...
        try {
            ...
            cache_1.cache.set(cacheKey, fixtures, 3600); // Cache for 1 hour
            return fixtures;
        }
        catch (error) {
    ...
    async getFixturesByTeam(teamId, options) {
        ...
        try {
            ...
            const fixtures = response.response || [];
            cache_1.cache.set(cacheKey, fixtures, 900); // Cache for 15 minutes
            return fixtures;
        }
        catch (error) {
     ...
     */
    async getFixturesByDate(date, league) {
    ...
    async getLiveFixtures(league) {
        ...
        try {
            const params = { live: league ? `${league}` : 'all' };
            const response = await this.client.get('/fixtures', params);
            const fixtures = response.response || [];
            cache_1.cache.set(cacheKey, fixtures, 60); // Cache for 1 minute (live data changes frequently)
            return fixtures;
        }
        catch (error) {
    ...
    async getFixtureById(fixtureId) {
        ...
        try {
            ...
            if (response.response && response.response.length > 0) {
                ...
                cache_1.cache.set(cacheKey, fixture, 600); // Cache for 10 minutes
                return fixture;
            }
            return null;
        }
     ...
     */
    async findMatchByIds(team1Id, team2Id, options) {
        try {
            ...
            const upcomingMatch = team1Fixtures.find(fixture => fixture.teams.away.id === team2Id || fixture.teams.home.id === team2Id);
     ...
     */
    async getCurrentSeasonFixtures(teamId, options) {
    ...
    async findMatch(params) {
        try {
            ...
            if (team2) {
                ...
                const upcomingMatch = team1Fixtures.find(fixture => fixture.teams.away.id === team2.id || fixture.teams.home.id === team2.id);
                if (upcomingMatch) {
     ...
     */
    async getMatchPrediction(fixtureId) {
        ...
        try {
            ...
            if (response.response && response.response.length > 0) {
                ...
                cache_1.cache.set(cacheKey, prediction, 3600); // Cache for 1 hour
                return prediction;
            }
            return null;
        }
    ...
    async getFixtureStatistics(fixtureId) {
        ...
        try {
            ...
            cache_1.cache.set(cacheKey, statistics, 600); // Cache for 10 minutes
            return statistics;
        }
        catch (error) {
